...
teste = 'letra inserida no campo QUANTIDADE'
word(teste)
...
teste = 'letras inseridas no campo VALOR'
word(teste)
...
teste = 'caractere especial - menor - inserido no campo DESCRIÇÃO'
word(teste)
...
teste = 'data impossivel no campo DATA DE RECEBIMENTO'
word(teste)
...
teste = 'unidade de medida nao selecionado'
word(teste)
