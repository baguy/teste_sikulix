...
teste = 'data de FIM menor que de INICIO'
word(teste)
...
teste = 'datas impossiveis nos camos INICIO e FIM'
word(teste)
...
teste = 'horario de FIM menor do que de INICIO'
word(teste)
...
teste = 'horarios impossiveis nos campos de HORARIOS'
word(teste)
...
teste = 'caractere especial - menor - inserido no campo TITULO'
word(teste)
