...
teste = 'mudar campo BAIRRO  - DEVE ser permitido'
word(teste)
...
teste = 'ESTADO invalido - DEVE apresentar mensagem de erro'
word(teste)
...
teste = 'letras inseridas no campo NUMERO da residencia - DEVE apresentar mensagem de erro'
word(teste)
